...
*Generated: 2026-01-30 11:54*
*PolicyEngine UK v2.72.2*
...
|--------|----------------------|-----------------|------------|
| Working-age adults in UC | 8.5m (26.0%) | 8.2m (18.8%) | -0.3m (-7.2pp) |
| Children in UC households | 6.5m (54.0%) | 5.2m (41.1%) | -1.3m (-12.9pp) |
| Annual UC expenditure | £86.0bn (2029-30) | £80.3bn (2025) | £-5.7bn |

### PolicyEngine Population Estimates

| Metric | Value |
|--------|-------|
| Total working-age population (16-64) | 43.7 million |
| Total children (under 16) | 12.6 million |
| Benefit units receiving UC | 6.39 million |
| Average annual UC award | £12,566 |
| Average monthly UC award | £1,047 |

### Additional RF Comparisons

| Metric | Resolution Foundation | PolicyEngine UK | Difference |
|--------|----------------------|-----------------|------------|
| Average monthly UC award | £1,030 | £1,047 | £+17 |
| UC families with children | 46.0% | 49.2% | +3.2pp |
| UC childcare recipients | 190k | 500k | +310k |
| Avg monthly childcare element | £420 | £244 | £-176 |
...
|--------|-----------------|
| Self-employed working-age adults | 4.88 million |
| Self-employed UC claimants | 0.25 million |
| Carers on UC | 0.53 million |
...
| Metric | PolicyEngine UK |
|--------|-----------------|
| Benefit units affected by cap | 233 thousand |
| Total annual reduction from cap | £603 million |
| Average annual loss | £2,584 |
| Average monthly loss | £215 |

**RF Recommendation #8:** Abolish benefit cap for those meeting work requirements.

**Impact of full abolition:** £603m restored to 233k households.
...
| Metric | PolicyEngine UK |
|--------|-----------------|
| Benefit units receiving UC childcare | 500 thousand |
| Total UC childcare expenditure | £1.46 billion |
| Average annual childcare element | £2,925 |
| Tax-Free Childcare households | 409 thousand |
| Total TFC value | £0.47 billion |
...
| Metric | Resolution Foundation | PolicyEngine UK | Difference |
|--------|----------------------|-----------------|------------|
| Workers with METR > 70% | 3.0% | 1.1% | -1.9pp |
| Non-workers with PTR > 70% | 9.0% | 0.0% | -9.0pp |
...
|---------|-------------------|----------------|
| **Total UC (net)** | **£80.3bn** | - |
| **Total UC (gross max)** | **£338.0bn** | **100%** |
| **Taper reduction** | **£257.7bn** | **76%** |
| Standard Allowance | £223.6bn | 66.2% |
| Child Element | £48.4bn | 14.3% |
| Housing Costs Element | £97.3bn | 28.8% |
| Childcare Element | £7.8bn | 2.3% |
| Disability Elements | £27.3bn | 8.1% |
| Carer Element | £2.5bn | 0.7% |
...
2. **Timing:** RF figures are projections for April 2026 (end of managed migration).
   PE shows 2025 entitlement under current rules.

3. **Data Sources:**
   - RF uses DWP StatXplore administrative data
   - PE uses Family Resources Survey (FRS) microsimulation

4. **Expenditure Year:** RF's £86bn is for 2029-30; PE's £80.3bn is for 2025.
...
|-------------------|------------|-------------|
| #1-3 MIF reforms | ✅ Yes | 0.25m self-employed UC claimants |
| #4 Carer MIF exemption | ✅ Yes | 0.53m carers on UC |
| #8 Benefit cap abolition | ✅ Yes | £603m to 233k households |
| #9 Childcare run-on | ✅ Yes | 500k receive UC childcare |
...
- PolicyEngine UK microsimulation model v2.72.2
